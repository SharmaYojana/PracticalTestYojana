...
public class Repost {
         ...
         * @param ipAddress
         */
        public Repost(String username, int verified, List<String> vanityUrls, int flagsPlatformLo, int repostId, String avatarUrl, int userId, String profileBackground, String created, User user, int postId, int ipAddress, int flagsPlatformHi, int sourceType, int sourceId) {
            super();
