...
public class Track {
     ...
     * @param artistName
     */
    public Track(int albumTrackCount, int hasAudioTrackTimeline, String trackName, int beatsPerMinute, int albumTrackNumber, String albumName, String releaseDate, String artistName, String albumArtist, String composer, String genre, int discNumber, int discCount) {
        super();
